...
#Part 2
minimize cost : sum{i in 1..years} 400*unskilled_to_semi_skilled_retrained[i]+500*semi_skilled_to_skilled_retrained[i]+200*unskilled_redundant[i]+500*semi_skilled_redundant[i]+500*skilled_redundant[i]+500*unskilled_shortterm[i]+400*semi_skilled_shortterm[i]+400*skilled_shortterm[i]+1500*unskilled_overmanning[i]+2000*semi_skilled_shortterm[i]+3000*skilled_shortterm[i];
